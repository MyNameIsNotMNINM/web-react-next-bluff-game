...
export const CylinderTransition = (props: CylinderTransitionProps) => {
    ...
    const variants = {
        visible: { translateX: "-50%", translateY: "-50%", top: "50vh", left: "50vw", position: "fixed" },
        hidden: { position: "relative" },
    }
    function animationEnd(event: string){
        if(event == "default"){
            console.log("fixedCylinder")
        ...
        <>
...

            {
                ...
                <motion.div
                    ...
                    variants={{
                        centered: { translateX: "-50%", translateY: "-50%", top: "50vh", left: "50vw"},
                        default: { translateX: "0", translateY: "0", top: fixedCylinderPos.y, left: fixedCylinderPos.x },
                    }}
