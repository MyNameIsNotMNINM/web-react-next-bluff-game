...
export const EnnemyPLayer = (props: EnnemyPLayerLeftProps) => {
    ...
    return (
        ...
        >
            ...
            >
                <ContextMenu>
                    <ContextMenuTrigger className={`flex flex-col-reverse justify-center items-center ${scaleX} `}>
                        <motion.div
                        ...
                        >
                            {new Array(props.playerData.cardAmount).fill(0).map((_, idx, arr) => {
                        ...
                        <Avatar onClick={() => setActive(!active)} className={`relative size-20 ${scaleX}`}>
                            ...
                            <div className="absolute w-full h-full" />
                            {
                                props.turnEndPercentage && <>
                                    ...
                                    <PieChart className="absolute top-[50%] left-[50%] -translate-y-[50%] -translate-x-[50%] w-[90%] h-[90%]" size={100} strokeWidth={50} segments={[
                                        { value: props.turnEndPercentage, color: "#ffffff " },
                                        { value: 100-props.turnEndPercentage, color: "#00000000" },
                                    ]}/>
                                </>
                            }
                        </Avatar>
                ...
                <div className="flex flex-col gap-1 justify-center items-center z-50">
                    <CylinderTransition chamberSize={0.5} chamberPosition={props.playerData.bulletChamber} chamberCount={6} centered={props.centered} />
                </div>
            </div>
        </div>
    );
