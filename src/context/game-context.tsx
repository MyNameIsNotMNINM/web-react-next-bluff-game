"use client";
import { CardTypes, PlayerActionGameMessage, PlayerActionMessage, UserId } from "@/lib/actions/playerActions";
import {
  GameState,
  ServerActionData,
  ServerActionHandler,
...
type GameContextType = {
  ...
  sendAction: (action: PlayerActionMessage) => Promise<void>;
...
export const WebSocketProvider: React.FC<{
  ...
  const sendAction = async (action: PlayerActionMessage) => {
    if (socket.current?.readyState === WebSocket.OPEN) {
